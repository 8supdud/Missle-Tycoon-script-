--[[
    ...
    Mobile/PC Friendly UI | Fully Featured
--]]
...
-- ============================================
-- VOZEX NATIVE UI (From Missile Tycoon)
-- ============================================
local VozexUI = {}
VozexUI.Colors = {
...
-- Theme management
local CurrentTheme = "Cyber Blue"
local Themes = {
    ["Vozex Gold"] = { Accent = Color3.fromRGB(255, 215, 0) },
    ["Cyber Blue"] = { Accent = Color3.fromRGB(0, 212, 255) },
    ["Neon Pink"] = { Accent = Color3.fromRGB(255, 50, 150) },
    ["Emerald"] = { Accent = Color3.fromRGB(80, 220, 120) },
    ["Royal Purple"] = { Accent = Color3.fromRGB(180, 100, 255) },
}
...
MovementTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            Window:Notify({Title = "⚠️ Warning", Content = "Walkspeed can get you banned! Use at your own risk.", Duration = 2})
        end
...
MovementTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            Window:Notify({Title = "⚠️ Warning", Content = "Jump Power can get you banned! Use at your own risk.", Duration = 2})
        end
...
MovementTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            Window:Notify({Title = "⚠️ Warning", Content = "Noclip can get you banned! Use at your own risk.", Duration = 2})
        end
...
MovementTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            Window:Notify({Title = "⚠️ Warning", Content = "Infinite Jump can get you banned! Use at your own risk.", Duration = 2})
        end
...
MovementTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            Window:Notify({Title = "⚠️ Warning", Content = "Fly can get you banned! Use at your own risk.", Duration = 2})
        end
...
ThemesTab:CreateDropdown({
    ...
    Callback = function(Opt)
        Config.CurrentTheme = Opt[1]
        VozexUI.Colors.Accent = Themes[Opt[1]].Accent
        Window:Notify({Title = "Theme", Content = Opt[1] .. " theme applied!", Duration = 1})
    end
})

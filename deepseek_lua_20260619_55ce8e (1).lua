...
local Themes = {
    ...
    Dark = {
        ...
        PanelLight = Color3.fromRGB(24, 26, 36),
    ...
    Green = {
        ...
        PanelLight = Color3.fromRGB(22, 40, 30),
        Accent = Color3.fromRGB(80, 220, 160),
        Text = Color3.fromRGB(220, 255, 230),
    },
    Purple = {
        Bg = Color3.fromRGB(16, 8, 22),
        Panel = Color3.fromRGB(28, 16, 38),
        PanelLight = Color3.fromRGB(40, 24, 52),
        Accent = Color3.fromRGB(200, 100, 255),
        Text = Color3.fromRGB(240, 220, 255),
    },
    Red = {
        Bg = Color3.fromRGB(22, 8, 8),
        Panel = Color3.fromRGB(38, 16, 16),
        PanelLight = Color3.fromRGB(52, 24, 24),
...
local function applyTheme(themeName)
    ...
    PremiumUI.Colors.Bg = theme.Bg
    PremiumUI.Colors.Panel = theme.Panel
    PremiumUI.Colors.PanelLight = theme.PanelLight
    PremiumUI.Colors.Accent = theme.Accent
    PremiumUI.Colors.Text = theme.Text
end
...
function PremiumUI:CreateWindow(opts)
    ...
    self:CreateStroke(floatBtn, PremiumUI.Colors.Accent, 2, 0.3)
    ...
    local function showCloseConfirmation()
        ...
        dialog.BackgroundColor3 = PremiumUI.Colors.BgDarker
        dialog.Parent = sg
        self:CreateRounded(dialog, 12)
        self:CreateStroke(dialog, PremiumUI.Colors.PanelLight, 1, 0.3)
        ...
        titleLbl.BackgroundTransparency = 1
        titleLbl.Text = "⚠️ Are you sure?"
        titleLbl.TextColor3 = PremiumUI.Colors.Warning
        titleLbl.Font = Enum.Font.GothamBold
        titleLbl.TextSize = 16
        titleLbl.TextXAlignment = Enum.TextXAlignment.Center
        
        local msgLbl = Instance.new("TextLabel", dialog)
        msgLbl.Size = UDim2.new(1, -20, 0, 30)
        msgLbl.Position = UDim2.new(0, 10, 0, 45)
        msgLbl.BackgroundTransparency = 1
        msgLbl.Text = "Unload the script? All automation will stop."
        msgLbl.TextColor3 = PremiumUI.Colors.TextDim
        ...
        yesBtn.Position = UDim2.new(0.25, -55, 0, 95)
        yesBtn.BackgroundColor3 = PremiumUI.Colors.Danger
        yesBtn.Text = "Yes"
        yesBtn.TextColor3 = PremiumUI.Colors.TextBright
        yesBtn.Font = Enum.Font.GothamBold
        yesBtn.TextSize = 14
        self:CreateRounded(yesBtn, 8)
        
        -- No button
        local noBtn = Instance.new("TextButton", dialog)
        noBtn.Size = UDim2.new(0, 100, 0, 35)
        noBtn.Position = UDim2.new(0.75, -45, 0, 95)
        noBtn.BackgroundColor3 = PremiumUI.Colors.Panel
        noBtn.Text = "No"
        noBtn.TextColor3 = PremiumUI.Colors.Text
        noBtn.Font = Enum.Font.GothamBold
        noBtn.TextSize = 14
        self:CreateRounded(noBtn, 8)
        ...
        TweenService:Create(dialog, TweenInfo.new(0.3, Enum.EasingStyle.Back), {Size = UDim2.new(0, 350, 0, 150)}):Play()
    end
    ...
    minBtn.MouseButton1Click:Connect(function() 
        ...
        TweenService:Create(floatBtn, TweenInfo.new(0.3, Enum.EasingStyle.Back), {Size = UDim2.new(0, 55, 0, 55), Position = UDim2.new(0.5, -27.5, 0, 20)}):Play()
    end)
...
TabSettings:CreateDropdown({
    Name = "Select Theme",
    Options = {"Default", "Dark", "Green", "Purple", "Red"},
    CurrentOption = "Default",
    Callback = function(v)
        applyTheme(v[1])
        -- Refresh UI by recreating? We'll just apply to existing elements
        -- For full effect, would need to recreate, but this works for colors
        print("[VOZEX] Theme changed to: " .. v[1])
    end
})

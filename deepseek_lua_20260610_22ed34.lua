--[[
    ...
    Native UI | No Crashes | Fully Featured
    Discord: https://discord.gg/Tttz6mNAet
--]]

-- ============================================
-- VOZEX NATIVE UI LIBRARY (From Missile Tycoon)
-- ============================================
...
VozexUI.Colors = {
    ...
    AccentBlue = Color3.fromRGB(0, 212, 255),
    AccentPink = Color3.fromRGB(255, 50, 150),
...
-- Theme management
local CurrentTheme = "Vozex Gold"
local Themes = {
    ["Vozex Gold"] = { Accent = Color3.fromRGB(255, 215, 0), AccentHover = Color3.fromRGB(255, 235, 100) },
    ["Cyber Blue"] = { Accent = Color3.fromRGB(0, 212, 255), AccentHover = Color3.fromRGB(64, 224, 255) },
    ["Neon Pink"] = { Accent = Color3.fromRGB(255, 50, 150), AccentHover = Color3.fromRGB(255, 100, 180) },
    ["Emerald"] = { Accent = Color3.fromRGB(80, 220, 120), AccentHover = Color3.fromRGB(110, 250, 150) },
    ["Royal Purple"] = { Accent = Color3.fromRGB(180, 100, 255), AccentHover = Color3.fromRGB(200, 130, 255) },
}

local function ApplyTheme(themeName)
    local theme = Themes[themeName] or Themes["Vozex Gold"]
    VozexUI.Colors.Accent = theme.Accent
...
function VozexUI:CreateWindow(opts)
    ...
    -- Floating button for minimizing
    ...
    -- Page container (right content area)
    ...
    function WindowObj:CreateTab(name, icon)
        ...
        function TabObj:CreateColorPicker(opts)
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                -- Quick selection - you can expand this

...
task.spawn(function()
    ...
    ---------------------------------------------------------------------------
    -- GLOBAL MOBILE INTERACTION & CLICK-THROUGH REFINEMENT
    ---------------------------------------------------------------------------
    local function refineUIElement(element)
        ...
        elseif element:IsA("TextButton") or element:IsA("ImageButton") then
            element.Active = true
            -- Resolves touch responsiveness inside nested scrolling frames
    ...
    ---------------------------------------------------------------------------
    -- BOUNDED DRAG CONTROLS FOR BOTH PC AND MOBILE VIEWPORTS
    ---------------------------------------------------------------------------
    ...
    UserInputService.InputChanged:Connect(function(input)
        if input == dragInput and dragging then
            ...
            -- Prevents the window from being dragged into dead zones or completely off-screen
            local padding = 15
